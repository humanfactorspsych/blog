...
지난 시간(4/30 저널클럽)에 이어 Gradient descent를 계산하는 numerical gradient와 analytical gradient에 대해 배웠다. Backpropagation을 computational graph를 통해 이해하는 시간을 가졌다. 

  [Lecture 4](http://cs231n.stanford.edu/slides/2017/cs231n_2017_lecture4.pdf) <br>

<br>

## Topic 1a: Diffusion Model [YK]

  Ratcliff & McKoon (2008)의 Diffusion Drift Model에 대해 간단히 알아보았다. Diffusion Drift Model은 물리학의 확산 모형에서 출발해 사람의 의사 결정 과정을 설명하기 위해 만들어진 모형이다. 2AFC task에 가장 최적화된 모형이다. 반응 시간(Reaction Time)을 정교하게 분석할 때 사용하며, 
...
<br>
  ...
  데이터셋 및 코드: https://github.com/rkosti/emotic

  프로젝트 페이지: http://sunai.uoc.edu/emotic/ 
...
## Topic 5: Virtual Medical Assistants [WE]
...
## Topic 5a: Robots with humanlike face display
...
## Topic 6: Impact of remote patient monitoring on clinical outcomes [HY] 
