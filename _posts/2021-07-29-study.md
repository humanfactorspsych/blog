...
---
    ...
    Themes: Conversational Agent, Expectation Violation Theory, Communication, AI interview, Blender Bot 2.0 : Open-Domain Chatbot with Long-Term Memory, Emotion and Sentiment Analysis in Music Lyrics

Presenters: HM (Hoyoung Maeng), MJ (Minjeong Ko), YL (Yoon Kyung Lee), RAs

-----------------

# Topic 1: Conversational Agent, Expectation Violation Theory, Communication [HM]
...
# Topic 4: Blender Bot 2.0 : Open-Domain Chatbot with Long-Term Memory [YK]
...
# Topic 5: Emotion and Sentiment Analysis in Music Lyrics [RAs]
